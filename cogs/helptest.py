# this cog is a work in progress testing a paginated help command. 
from discord.ext import commands

from utils.util import Pag

class Helptest(commands.Cog, name="Helps command"):
    ...
    @commands.command(
        name="helps", aliases=["hh", "commands"], description="The help command!"
    )
